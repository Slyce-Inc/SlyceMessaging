...
import it.slyce.messaging.message.messageItem.scout.media.MessageScoutMediaItem;
import it.slyce.messaging.message.messageItem.user.media.MessageUserMediaItem;
